...
namespace D2P.GHPlugin.Components.GHComponents.Stream {
    public class GHStreamComponentsByType : GHComponentStreamBase {
        ...
        protected override void AppendAdditionalComponentMenuItems(ToolStripDropDown menu) {
            ...
            var negateItem = Menu_AppendItem(menu,"NegateRegexFilter",NegateRegexFilterHandler,true,reverseRegex);
            negateItem.ToolTipText = "When true the name-filter will be negated";
        }
